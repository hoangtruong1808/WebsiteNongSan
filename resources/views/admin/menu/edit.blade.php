                ...
                <form action="{{ route('menu_update',['menu_id'=>$menu->id]) }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="form" name="name" class="form-control" value="{{ $menu->name }}" id="name" placeholder="Nhập tên danh mục" required>
                        </div>
    
                        <div class="form-group">
                            <label for="description">Mô tả</label>
                            <textarea id="description" name="description" class="form-control" required>{{ $menu->description}}
                            </textarea>
                        </div>
