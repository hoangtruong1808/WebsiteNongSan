                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div style=" display:block">
                                ...
                                <input type="datetime-local" name="date_start" class="form-control"  style="width:35%; display:unset"  id="date_start">
                                <label for="date_end" style="font-weight: normal; margin-left: 3%">Đến: </label>
                                <input type="datetime-local" name="date_end" class="form-control"  style="width:35%; display:unset"  id="date_end">
                            </div>
                        </div>
                        <div class="form-group">
