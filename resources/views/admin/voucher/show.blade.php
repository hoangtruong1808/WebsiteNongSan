...
@section('content')
            ...
            <table style="text-align: center" class="table table-bordered" id="datatable" >
                ...
                <tr id="row{{$item->ID}}">
                    ...
                    <td>
                        <a href="{{ route('voucher_edit',['voucher_id' => $item->ID]) }}" title="Cập nhật voucher"> <i class="fas fa-edit"></i>
                        </a>
                        <a href="" class="delete-button" data-toggle="modal" data-target="#delete-data" data-id="{{$item->ID}}" style="color:red" title="Xóa mã giảm giá">
